...
const Nav = ({ favoriteDogs, favoriteDialogRef }: NavProps) => {
  ...
  return (
    <div className="fixed top-0 z-50 flex h-fit w-screen items-center justify-end gap-8 border border-b-2 bg-white py-2">
      ...
      <button
        className="mr-4 rounded-md px-1 text-black transition hover:cursor-pointer hover:bg-white/20"
