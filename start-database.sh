...
DB_CONTAINER_NAME="dog-adoption-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=dog-adoption -d -p 5432:5432 docker.io/postgres
